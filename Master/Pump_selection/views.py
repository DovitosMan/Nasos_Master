...
def pump_selection(request):
    context = {
        'selects': [
            ...
            {'type': 'hz', 'placeholder': 'Тmax среды, ℃:', 'name': 'max_temperature', 'class': 'Select_a_value_4',
             'value': ''},
            {'type': 'input', 'placeholder': 'Pmax на входе, МПа:', 'name': 'max_pressure', 'class': 'Select_a_value_5',
             'value': ''},
            {'type': 'hz', 'placeholder1': 'Список насосов',
             'keys': ['Насосы консольные "К"', 'Насосы консольные моноблочные "КМ"', 'Насосы линейные циркуляционные',
                      'Насосы двухстороннего входа', 'Насосы секционные',
